...
<template>
  <div class="relative flex items-top justify-center min-h-screen bg-white-secondary sm:items-center sm:pt-0">
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-blue-primary overflow-hidden shadow sm:rounded-lg p-6">
        <h2 class="text-2xl leading-7 font-semibold">
          Welcome to your Nuxt Application
        </h2>
        <p class="mt-3 text-white-primary">
        ...
        <p class="mt-4 pt-4 text-white-primary border-t border-dashed">
      ...
      <div class="flex justify-center pt-4 space-x-2">
        <a href="https://github.com/nuxt/nuxt.js" target="_blank"><svg
          class="w-6 h-6 text-white-primary button--github"
        ...
        <a href="https://twitter.com/nuxt_js" target="_blank"><svg
          class="w-6 h-6 text-white-primary"
          xmlns="http://www.w3.org/2000/svg"
          xmlns:xlink="http://www.w3.org/1999/xlink"
          aria-hidden="true"
          role="img"
